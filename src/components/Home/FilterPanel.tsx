    ...
    <section className="f-col">
      <div className="relative" ref={dropdownRef}>
        <div
          ...
          className="cursor-pointer f-ic gap-2 rounded-full bg-white px-4 py-1 text-primary-200 font-semibold
        ...
        {isOpen && (
          <motion.div
            ...
            className="absolute w-[261px] top-full right-0 z-10 mt-2 p-4 pt-0 bg-white rounded-xl shadow"
          >
            <HorizontalSelector
              title="성별"
